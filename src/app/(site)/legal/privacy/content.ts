...
export const PRIVACY_SECTIONS = [
	...
	},
	{
		...
		clauses: [
			{
				heading: "Data Access",
				body: "You may request a copy of any personal data I hold about you. Contact me at hello@siamparvez.com and I will provide your data in a portable format within 30 days.",
			},
			{
				heading: "Data Deletion",
				body: "To request deletion of any data associated with you, contact me at hello@siamparvez.com. I will process your request within 30 days of receiving it.",
			},
			{
				heading: "GDPR Compliance",
				body: "For users in the European Economic Area: you have rights under GDPR including access, rectification, erasure, and portability. These rights can be exercised by contacting me directly at hello@siamparvez.com.",
			},
		],
	},
	{
	...
	},
	{
		...
		clauses: [
			...
			},
			{
				...
				body: "For any privacy-related inquiries, requests, or complaints, contact: hello@siamparvez.com. I aim to respond to all privacy requests within 30 days.",
			},
		],
	},
] as const;
